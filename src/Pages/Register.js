    ...
    const chageUserData = (e) => {
        ...
        if(name == "firstname"){
            ...
            setErrors({
                ...
                : e.target.value.length<3 ? "Enter at least three characters" 
                : !valid.firstname && "please enter a valid name" 
            })
            ...
            setErrors({
                ...
                : e.target.value.length<3 ? "Enter at least three characters" 
                : !valid.lastname && "please enter a valid name" 
            })
            ...
            setErrors({
                ...
                usernameError: e.target.value.length == 0 ? "This Field Is Required"
                 : e.target.value.length<3 ? "Enter at least three characters" 
                 : !valid.username && "please enter a valid name" 
            })
        }
        else if(name == "email"){
            ...
            setErrors({
                ...
                : !(localStorage.getItem(userData.email)) && "This email is already sign up before"

            })
        }
        else if(name == "password"){
            const passRegex =  /\w/ //[[\D]*.]{8,}/  //[a-zA-Z]/ //;
            ...
            setErrors({
                ...
                : e.target.value.length < 8 && "please enter at least 8 characters containes special characters"
            })
        }else{
            setUserData({
                ...userData,
              ...
              <div className="card-body p-4 p-lg-5 text-black">
                ...
                {/* confirm password */}
                  ...
                  <div className="pt-1 mb-4 d-flex justify-content-center">
                    <button className="btn btn-dark btn-lg btn-block" type="submit" name="Submit" 
