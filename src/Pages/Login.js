    ...
    const chageUserData = (e) => {
        ...
        if(e.target.name === "email"){
            ...
            setErrors({
                ...
                : !valid.password && "please enter at least 8 characters containes special characters"
                // : !(userData.password === _password) && "InCorrect Password"
            })
        }
    }
